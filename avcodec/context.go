...
func (cctx *Context) AvcodecParametersFromContext(par *AvCodecParameters) int {
	return int(C.avcodec_parameters_from_context((*C.struct_AVCodecParameters)(par), (*C.struct_AVCodecContext)(cctx)))
}
...
func (ctxt *Context) GetTimebase() Rational {
...
func (ctxt *Context) SetEncodeParams3(width int, height int, pxlFmt PixelFormat, hasBframes bool, gopSize int, bitRate int64) {
	ctxt.width = C.int(width)
	ctxt.height = C.int(height)
...
func (cctx *Context) SetFlags(flags int) {
	cctx.flags = cctx.flags | C.int(flags)
}
